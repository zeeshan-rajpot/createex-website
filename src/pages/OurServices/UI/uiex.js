...
import UIExecution from "../Index.js";
import ui from "../../../SVG/uiImg.svg";
...
const uiex = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="UI Execution" />
      <UIExecution
        Logo={ui}
        Whyus="Why Choose Our"
        mainHeading="UI Execution Services?"
        ...
        h3="Benefits of Our UI Execution Services:"
