...
import AppDesign from "../Index.js";
import Appimg from "../../../SVG/appdesignimg.svg";
...
const   Appdesign = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="App Design" />
      <AppDesign
        Logo={Appimg}
        Whyus="Why Choose Our"
        mainHeading="App Design Services?"
        ...
        h3="Benefits of Our App Design Services:"
