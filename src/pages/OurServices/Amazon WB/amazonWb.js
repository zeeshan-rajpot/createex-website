...
import AmazonWB from "../Index.js";
import Amazonwb from "../../../SVG/Awbimg.svg";
...
const amazonWb = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="Amazon Web Services" />
      <AmazonWB
        Logo={Amazonwb}
        Whyus="Why Choose Our"
        mainHeading="Amazon Web Services?"
        ...
        h3="Benefits of Our Amazon Web Services:"
