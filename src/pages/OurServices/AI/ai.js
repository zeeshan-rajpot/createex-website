...
const amazonWb = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="Artificial Intelligence Services" />
      <AI
        Logo={ai}
        Whyus="Why Choose Our"
        mainHeading="Artificial Intelligence Services?"
        ...
        h3="Benefits of Our Artificial Intelligence Services:"
