...
import ECommerce from "../Index.js";
import Ecommercelogo from "../../../SVG/Ecommerceimg.svg";
...
const ecommerce = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="E-Commerce" />
      <ECommerce
        Logo={Ecommercelogo}
        Whyus="Why Choose Our"
        mainHeading="E-Commerce Services?"
        ...
        h3="Benefits of Our E-Commerce Services:"
