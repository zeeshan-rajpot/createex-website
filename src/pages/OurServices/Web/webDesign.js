...
import WebDesign from "../Index.js";
import webimg from "../../../SVG/webdesignimg.svg";
...
const webDesign = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="Web Design" />
      <WebDesign
        Logo={webimg}
        Whyus="Why Choose Our"
        mainHeading="Web Design Services?"
        ...
        h3="Benefits of Our Web Design Services:"
