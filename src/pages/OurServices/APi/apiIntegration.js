...
import ApiIntegraion from "../Index.js";
import Api from "../../../SVG/apiImg.svg";
...
const apiIntegration = () => {
  return (
    <>
      {" "}
      <NavBar pageTitle="Api Integration " />
      <ApiIntegraion
        Logo={Api}
        Whyus="Why Choose Our"
        mainHeading="Api Integration Services?"
        ...
        h3="Benefits of Our Api Integration Services:"
